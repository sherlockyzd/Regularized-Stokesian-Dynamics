...
contains
  ...
  !*******************************************************
  subroutine InitPrtclProperty(this,chFile,RadiusIn)
    implicit none
    class(PhysicalProperty)::this
    character(*),intent(in)::chFile
    real(RK),intent(in)::RadiusIn
    ...
    this%nPrtcl_in_Bin(1)=DEM_opt%numPrtcl
        
     ! calculate particle properties
     do i = 1, nPType
       this%Prtcl_PureProp(i)%Density = Density(i)
       this%Prtcl_PureProp(i)%Radius = RadiusIn*1.0D-3!half * Diameter(i)
  ...
  subroutine Finalize(this)
    ...
    deallocate(this%nPrtcl_in_Bin,this%CS_Hrchl_level,this%Prtcl_PureProp,    &
               this%Wall_PureProp,this%Prtcl_BnryProp,this%PrtclWall_BnryProp )      
