...
real(kind=cp) :: x11g,x12g,y11g,y12g,y11h,y12h,x11m,y11m,z11m,x12m,y12m,z12m
   ...
   do beta=alpha+1,ntotal
      ...
      !endif
        ...
        call lubtabcalc(s,x11a,x12a,y11a,y12a,y11b,y12b,x11c,x12c,y11c,y12c,&
              & x11g,x12g,y11g,y12g,y11h,y12h,x11m,y11m,z11m,x12m,y12m,z12m)
...
open(unit = 1001,file = 'lubdat/lubscalar.txt',status = 'old')
read(1001,'(a80)') line
!read(1001,'(a80)') line

do i = 1, nt
read( 1001, * ) tr(i),tx11a(i),tx12a(i),ty11a(i),ty12a(i),&
            & ty11b(i),ty12b(i),tx11c(i),tx12c(i),ty11c(i),ty12c(i), &
            & tx11g(i),tx12g(i),ty11g(i),ty12g(i),ty11h(i),ty12h(i), &
            & tx11m(i),tx12m(i),ty11m(i),ty12m(i),tz11m(i),tz12m(i)
